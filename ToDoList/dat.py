...
class DAT:
    ...
    def _format_list(self, todo_list, format):
        # Formats the array into a dictionary, could this be built in?
        rows = []
        for sql_row in todo_list:
            row = {}
    ...
    def add_to_todo_list(self, message, due_date, description_elements, priority=0):
    ...
    def dump_database(self):
        cursor = self.database_connection.cursor()
        todo_list = cursor.execute('SELECT * FROM todo_list')
